        ...
        <div className='flex flex-wrap'>
          <div className='w-full sm:w-1/5 p-5'>
            <ul className='space-y-3'>
              ...
              <li className='text-lg border-b-2 cursor-pointer' onClick={() => setOpenTab(2)}>Your Restaurant </li>
          ...
          <div className={`${openTab === 1 ? "block" : "hidden"} w-full sm:w-4/5 p-5`}>
              ...
              <div className='flex gap-7 '>
                ...
                <div>
                  <ul className='border-l-2 pl-5'>
                    <li className='py-3 text-lg font-normal capitalize'>{user.ownerName}</li>
            ...
            <div className='flex flex-wrap'>
              <div className='flex w-full sm:w-1/2 flex-col'>
                ...
                <div className='flex'>
                  <ul className='pr-2'>
                    <li className='py-3 text-lg font-extralight'>Account No.</li>
                    <li className=' text-lg font-extralight'>IFSC Code</li>
                    <li className='py-3 text-lg font-extralight'>Account type</li>
                  </ul>
                  <ul className='border-l-2 pl-5'>
                    <li className='py-3 text-lg font-normal capitalize'>{user.bankDetails.ACnumber}</li>
                    <li className=' text-lg font-normal'>{user.bankDetails.IFSC}</li>
                    <li className='py-3 text-lg font-normal'>{user.bankDetails.actype}</li>
                  </ul>
                </div>
              </div>
              <div className='flex w-full sm:w-1/2 flex-col'>
                ...
                <div className='flex'>
                  ...
                  <ul className='border-l-2 pl-5'>
                    <li className='py-3 text-lg font-normal capitalize'>{user.panCard.holderName}</li>
                    <li className='py-3 text-lg font-normal'>{user.panCard.number}</li>
                  </ul>
                </div>
              </div>
          ...
          <div className={`${openTab === 2 ? "block" : "hidden"} w-full sm:w-4/5 p-5`}>
            <h1 className='text-xl font-semibold pb-5 capitalize'>Your Restaurant</h1>
            <div className='w-3/4 h-full '>
              <div className='flex gap-7 '>
                <div>
                  <ul className=''>
                    <li className='py-3 text-lg font-extralight'>Restaurant Name</li>
              ...
              <div className='flex gap-7 '>
                <div>
                  <ul className=''>
                    <li className='py-2 text-lg font-extralight'>Restaurant Type</li>
                    <li className='py-2 text-lg font-extralight'>Total Listed products</li>
                    <li className='py-2 text-lg font-extralight'>Total Received order</li>
                  </ul>
                </div>
                <div>
                  <ul className='border-l-2 pl-5'>
                    <li className='py-2 text-lg font-normal capitalize'>{user.outLetType}</li>
                    <li className='py-2 text-lg font-normal capitalize'>{user.product.length}</li>
                    <li className='py-2 text-lg font-normal capitalize'>{user.order.length}</li>
                  </ul>
