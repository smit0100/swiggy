                    ...
                    <thead>
                      <tr className="bg-gray-100 text-gray-600 uppercase text-sm leading-normal">
                        ...
                        <th className="py-3 px-6 text-left">
                          <select className='outline-none border-none bg-inherit border-b-2 border-black' value={filter} onChange={(e) => setFilter(e.target.value)}>
