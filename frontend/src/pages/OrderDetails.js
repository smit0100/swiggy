...
const OrderDetails = () => {
  ...
  return (
    <>
                ...
                <div className="flex  flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0 ">
                  ...
                  <div className="flex justify-between xl:h-full  items-stretch w-full flex-col mt-6 md:mt-0">
                    <div className="flex justify-center md:justify-start xl:flex-col flex-col md:space-x-6 lg:space-x-8 xl:space-x-0 space-y-4 xl:space-y-12 md:space-y-0 md:flex-row  items-center md:items-start ">
                      ...
                      {
                        orderData !== null && orderData.status === "delivered" ?

                          <div className="mt-4 flex justify-center md:justify-start  items-center md:items-start flex-col space-y-4 ">
                          {
                            isDeliveryButton!=true &&  isResturantButton != true ? <p className="text-base font-semibold leading-4 text-center md:text-left text-gray-800">
                            Review 
                          </p> : ''
                          }
                            ...
                            <p className="w-48 lg:w-full xl:w-48 text-center md:text-left text-sm leading-5 text-gray-600">

                              {
                                ...
                                <button onClick={(e) => setRestroReview(true)} className="inline-block mt-3 bg-white hover:text-white hover:bg-blue-600 -bottom-4 font-bold  rounded border border-current px-2 py-[6px] text-xs uppercase  text-blue-600 transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:text-blue-500">
                                  Review for Restaurant
                                </button>

                              }
                              {
                                isDeliveryButton!=true && <button onClick={(e) => setDeliveryReview(true)} className="inline-block mt-3 bg-white hover:text-white hover:bg-blue-600 -bottom-4 font-bold  rounded border border-current px-2 py-[6px] text-xs uppercase  text-blue-600 transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:text-blue-500">
      ...
      {restroReview && <RestroReview setIsResturantButton={setIsResturantButton} setRestroReview={setRestroReview} orderId={orderId} resturantID={orderData != null && orderData.resturant._id} />}
      {deliveryReview && <DeliveryReview setIsDeliveryButton={setIsDeliveryButton} setDeliveryReview={setDeliveryReview} orderId={orderId} deliverboyId={orderData != null && orderData.deliveryBoy._id} />}
    </>
  );
};
