...

{
  isLoading === true ? <Loader /> :
                      ...
                      orderData !== null && orderData.status === "delivered" ?
                        ...
                        <div className="mt-4 flex justify-center md:justify-start  items-center md:items-start flex-col space-y-4 ">
                          ...
                          <p className="w-48 lg:w-full xl:w-48 text-center md:text-left text-sm leading-5 text-gray-600">
                            ...
                            <button onClick={(e) => setDeliveryReview(true)} className="inline-block mt-3 bg-white hover:text-white hover:bg-blue-600 -bottom-4 font-bold  rounded border border-current px-2 py-[6px] text-xs uppercase  text-blue-600 transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:text-blue-500">
      ...
      {restroReview && <RestroReview setRestroReview={setRestroReview} />}
      {deliveryReview && <DeliveryReview setDeliveryReview={setDeliveryReview} />}
    </>
  );
};
