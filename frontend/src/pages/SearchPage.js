                    ...
                    <div className=''>
                        {
                            load === true ? (
                                <div className="flex justify-center items-center h-screen w-screen ">
                                    ...
                                    <div onClick={()=>redirectRestaurent(restaurant.resturnat)} class="flex items-center border rounded-lg p-6 shadow-lg mt-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <button onClick={(e) => { e.preventDefault(); addtoCart(restaurant.resturnat,restaurant._id) }} class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline absolute z-50">Add to cart</button>
                                            </div>
                                        </div>
                                    </div>
