    ...
    (async () => {
      try {
        ...
        const response = await axios.get(
          ...
          }/product/fetchAll?q=${search}&pageNumber=${pageNumber}&pageSize=${10}`
        );
          ...
          <div className="w-[70%] px-5">
            {load === true ? (
              ...
              data.map((restaurant) => (
                <div className="cursor-pointer">
                  <div
                    onClick={() => redirectRestaurent(restaurant.resturnat)}
                    className="bg-white flex items-center border rounded-tl-2xl rounded-br-2xl p-3 shadow-lg mt-4"
                  >
                    <img
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex items-center justify-between w-full">
                        ...
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            addtoCart(restaurant.resturnat, restaurant._id);
                          }}
                          className=" text-center hover:bg-black text-black hover:text-white p-2 px-5 rounded-tl-2xl rounded-br-2xl duration-200 border border-black mt-5 hover:scale-95"
                        >
                          Add to cart
                        </button>
                      </div>
            ...
            <div className="py-5">
              <div className="flex w-full justify-center">
                ...
                <button
                  className="bg-orange-100 rounded-l-3xl hover:bg-orange-50 text-gray-800 font-bold py-2 px-4"
                ...
                <button
                  href="#"
                  className="bg-orange-100 rounded-r-3xl hover:bg-orange-50 text-gray-800 font-bold py-2 px-4"
