                  ...
                  <div className="relative p-6 flex-auto space-x-4">
                    <form className='flex flex-col'>
                      ...
                      <div className="relative flex w-full flex-wrap items-stretch mb-3 pt-2">
                        ...
                        <input type="text" value={user.name} onChange={(e) => setName(e.target.value)} id='name' placeholder="Enter Your Name" className="px-3 py-3 placeholder-slate-300 text-slate-600 relative bg-white rounded text-sm border border-slate-300 outline-none focus:outline-none focus:ring w-full pl-10" />
                      ...
                      <div className="relative flex w-full flex-wrap items-stretch mb-3 pt-2">
                        ...
                        <input type="text" value={user.number} onChange={(e) => setNumber(e.target.value)} id='number' placeholder="Enter Your Number" className="px-3 py-3 placeholder-slate-300 text-slate-600 relative bg-white rounded text-sm border border-slate-300 outline-none focus:outline-none focus:ring w-full pl-10" />
                      </div>
                      ...
                      <div className="relative flex w-full flex-wrap items-stretch mb-3 pt-2">
                        ...
                        <input type="email" id='email' placeholder="Enter Your Email" value={user.email} onChange={(e) => setEmail(e.target.value)} className="px-3 py-3 placeholder-slate-300 text-slate-600 relative bg-white rounded text-sm border border-slate-300 outline-none focus:outline-none focus:ring w-full pl-10" />
                      </div>
                  ...
                  <div className="relative p-6 flex-auto space-x-4">
                    <form className='flex flex-col'>
                      ...
                      <div className="relative flex w-full flex-wrap items-stretch mb-3 pt-2">
                        ...
                        <input type="text" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} id='rnewpassword' placeholder="Re-enter New Password" className="px-3 py-3 placeholder-slate-300 text-slate-600 relative bg-white rounded text-sm border border-slate-300 outline-none focus:outline-none focus:ring w-full pl-10" />
                      </div>
                    </form>
                  </div>
                  {/*footer*/}
