  ...
  return (
    <>
      <div className="justify-between mb-6 rounded-lg bg-orange-200 p-6 shadow-md sm:flex sm:justify-start">
        <img src={`${item?.product.imageUrl}`} alt="food pic" className="w-full rounded-lg sm:w-40" />
        <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
          ...
          <div className="mt-4 flex justify-between im sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
            <div className="flex items-center border-black">
              <button onClick={decrease} className="cursor-pointer rounded-l bg-orange-300 py-1 px-3 duration-100 hover:bg-orange-400 hover:text-white text-lg font-bold"> - </button>
              <div className="h-8 w-7 border-t border-b border-black bg-inherit text-center text-lg " type="number" >{item?.quantity}</div>
              <button onClick={increase} className="cursor-pointer rounded-r bg-orange-300 py-1 px-3 duration-100 hover:bg-orange-400 hover:text-white text-lg font-bold"> + </button>
            </div>
