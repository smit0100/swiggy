...
const Navbar = () => {
        ...
        <div className="justify-between px-4 lg:max-w-screen md:items-center md:flex md:px-8">
            ...
            <div>
                ...
                <i className="fa-solid fa-location-dot pr-3"></i>Location
                        ...
                        <li className="text-gray-600 hover:text-blue-600">
                            <Link to="javascript:void(0)">Search</Link>
                        </li>
                        <li className="text-gray-600 hover:text-blue-600">
  ...
  //     <div className="fixed z-200 w-full bg-red-50">
  ...
  //             <a
  //               href="#"
  //               className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-gray-600 bg-indigo-600 hover:bg-indigo-700"
  //             >
  //               Sign up
  //             </a>
  //           </div>
  ...
  //               <a
  //                 href="#"
  //                 className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-gray-600 bg-indigo-600 hover:bg-indigo-700"
  //               >
  //                 Sign up
  //               </a>
  ...
  //             <li>
  //               <Link to="/search" className="block py-2 pl-3 pr-4  rounded text-gray-600 text-lg">
  //                 <i className="fa-solid fa-magnifying-glass pr-3"></i>Search
  //               </Link>
  //             </li>

  //             <li>
  //               <Link to="/help" className="block py-2 pl-3 pr-4  rounded text-gray-600 text-lg">
  ...
  //               </Link>
  //             </li> : <li>
  //               <Link to="/login" className="block py-2 pl-3 pr-4  rounded text-gray-600 text-lg">
  ...
  //             {
  //               isUser ? <li>
  //               <Link to="/cart" className="block py-2 pl-3 pr-4 rounded text-gray-600 text-lg">
