        ...
        <div className="justify-between px-4 lg:max-w-screen md:items-center md:flex md:px-8">
          <div>
            <div className="flex items-center justify-between py-3 md:py-5 md:block">
              <Link to="/">
                <img src='https://svgshare.com/i/rWj.svg' className="w-14 h-auto" />
              </Link>
            ...
            >
              <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                ...
                <li className="text-gray-600 hover:text-blue-600">
                  ...
                  <Link to="/search" className='flex items-center'><BiSearch className='text-lg'/>&nbsp; Search</Link>
                </li>
                
                <li className="text-gray-600 hover:text-blue-600">
                  <Link to="/contactus" className='flex items-center'><IoInformationCircleSharp className='text-lg'/>&nbsp; Contact Us</Link>
                </li>
                {
                  isUser ? <>
                    <li>
                      <Link to="/profile" className="py-2 pl-3 pr-4  rounded text-gray-600 text-lg flex items-center">
                        <HiOutlineUser className='text-lg'/>&nbsp;{isUser != null ? isUser.name : "profile"}
                      </Link>
                    </li>
                    {/* <li>
                    ...
                    <li>
                      <Link to="/cart" className=" w-16 rounded text-gray-600 text-lg flex justify-evenly hover:text-blue-800">
                        <div className='flex justify-center items-end relative w-7 h-7'>
                          <img alt="veg" className="w-full h-full absolute" src="https://svgshare.com/i/rXS.svg" />
                    ...
                    <li className="text-gray-600 hover:text-blue-600">
                      <Link to="/login" className='flex items-center'><HiOutlineUser className='text-lg'/>&nbsp;Login</Link>
                    </li>
                }
              </ul>
            </div>
